...
alias isc_att_handle = FB_API_HANDLE;
alias isc_blob_handle = FB_API_HANDLE;
alias isc_db_handle = FB_API_HANDLE;
alias isc_req_handle = FB_API_HANDLE;
alias isc_stmt_handle = FB_API_HANDLE;
alias isc_svc_handle = FB_API_HANDLE;
alias isc_tr_handle = FB_API_HANDLE;
 ...
 */
enum DSC_null = 1;
enum DSC_no_subtype = 2; /* dsc has no sub type specified */
enum DSC_nullable = 4; /* not stored. instead, is derived
                 from metadata primarily to flag
                 SQLDA (in DSQL)               */

enum dtype_unknown = 0;
enum dtype_text = 1;
enum dtype_cstring = 2;
enum dtype_varying = 3;
...
enum dtype_quad = 10;
enum dtype_real = 11;
enum dtype_double = 12;
enum dtype_d_float = 13;
enum dtype_sql_date = 14;
enum dtype_sql_time = 15;
enum dtype_timestamp = 16;
enum dtype_blob = 17;
enum dtype_array = 18;
enum dtype_int64 = 19;
enum dtype_dbkey = 20;
enum DTYPE_TYPE_MAX = 21;

enum ISC_TIME_SECONDS_PRECISION = 10000;
enum ISC_TIME_SECONDS_PRECISION_SCALE = -4;
...
extern(C) {
  ...
  ISC_STATUS isc_commit_transaction(ref ISC_STATUS_ARRAY,
                         isc_tr_handle *);
  ...
  ISC_STATUS isc_detach_database(ref ISC_STATUS_ARRAY,
                        isc_db_handle *);

  //ISC_STATUS ISC_EXPORT isc_drop_database(ISC_STATUS *,
  //                    isc_db_handle *);

  ISC_STATUS isc_dsql_allocate_statement(ref ISC_STATUS_ARRAY,
                            isc_db_handle *,
                            isc_stmt_handle *);
  ...
  ISC_STATUS isc_dsql_execute(ref ISC_STATUS_ARRAY,
                       isc_tr_handle*,
                       isc_stmt_handle*,
                       ushort,
                       const XSQLDA*);
  ...
  ISC_STATUS isc_dsql_fetch(ref ISC_STATUS_ARRAY,
                     isc_stmt_handle *,
                     ushort,
                     const XSQLDA *);
  ...
  ISC_STATUS isc_dsql_free_statement(ref ISC_STATUS_ARRAY,
                          isc_stmt_handle *,
                          ushort);
  ...
  ISC_STATUS isc_dsql_prepare(ref ISC_STATUS_ARRAY,
                       isc_tr_handle*,
                       isc_stmt_handle*,
                       ushort,
                       const ISC_SCHAR*,
  ...
  ISC_STATUS isc_print_status(ref const ISC_STATUS_ARRAY);
  ...
  ISC_STATUS isc_start_transaction(ref ISC_STATUS_ARRAY,
                             isc_tr_handle*,
                             short, ...);
...
enum isc_blob_filter_open = 0;
enum isc_blob_filter_get_segment = 1;
enum isc_blob_filter_close = 2;
enum isc_blob_filter_create = 3;
enum isc_blob_filter_put_segment = 4;
enum isc_blob_filter_alloc = 5;
enum isc_blob_filter_free = 6;
enum isc_blob_filter_seek = 7;
